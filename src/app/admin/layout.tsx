...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  // Always render the same structure, but conditionally show content after mount
  if (!mounted) {
    // During SSR and initial hydration, render consistent structure
    return (
  ...
  // After mount, show loading state if still checking auth
  if (loading) {
    return (
      <div className="min-h-screen bg-neutral-50 flex flex-col">
        <header className="bg-white border-b border-neutral-200 flex-shrink-0">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside className={cn(
          ...
          <nav className="p-4 space-y-2 flex-1 overflow-y-auto">
            ...
            {/* Use suppressHydrationWarning to prevent mismatch when isSuperAdminUser changes */}
